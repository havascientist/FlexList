  ...
  <div class="container">
	...
	<form id="add-task-form">
		<div class="task-input">
            <input type="hidden" name="username" id="username" value="<?php echo $sess_username; ?>">
            <input type="text" name="task" id="task" placeholder="Tambah list anda disini..">
        </div> 
          <div class="controls">
            <div class="filters">
	...
	<ul id="task-list" class="task-box"></ul>
	</div>
    ...
    <div class="row text-center text-white">
      ...
      <form method="POST">
          ...
          if (isset($_POST['note'])) {
              ...
              if ($insert == TRUE) {
                  echo '<script>alert("Note berhaasil dibuat.")</script>';
              } else {
